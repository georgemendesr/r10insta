...
- Gramática perfeita e natural
 ...
 - Evite terminar com particípios sem complemento (ex.: "nomeado", "anunciado", "confirmado"). Se aparecerem, complete o cargo/ação quando inferível pelo contexto; caso contrário, reescreva para ficar completo sem depender deles.
    ...
    const textSvg = `
      <svg width="${dimensions.width}" height="${dimensions.height}" xmlns="http://www.w3.org/2000/svg">
        ...
        ${chapeuFinal ? `
          ...
          <text x="${textX}" y="${barY + 29}" fill="white" font-family="Poppins, Arial" font-size="33" font-weight="600" text-anchor="middle">${escapeXmlText(chapeuFinal)}</text>
        ` : ''}
